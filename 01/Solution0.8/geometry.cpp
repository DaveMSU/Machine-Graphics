...
Vec3f Vec3f::operator-() const {   	            // Перегрузка унарного оператора минус.
...
Vec3f Vec3f::normalize() const{ // Приведение к нормированному виду с нормой = 1.
...
float Vec3f::length() const { // Получаем длину вектора.
